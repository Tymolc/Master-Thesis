...
\begin{figure}
  ...
  \begin{minipage}{.5\textwidth}
    \centering
    \includegraphics[width=.9\linewidth, angle=270]{Hardware/connector.JPG}
    \captionof{figure}{The connector is inserted into the bottle opening ...}
    \label{fig:connector}
  \end{minipage}%
  \begin{minipage}{.5\textwidth}
    \centering
    \includegraphics[width=.9\linewidth, angle=270]{Hardware/connector_with_cuff.JPG}
    \captionof{figure}{... and secured with a cuff}
    \label{fig:connector_with_cuff}
  \end{minipage}
\end{figure}

\subsection{Hinging Hubs}
...
\begin{figure}[h!]
    \includegraphics[width=\textwidth]{Hardware/valves.JPG}
    \centering
...
\begin{figure}[h!]
    \includegraphics[width=\textwidth]{Hardware/position_controller.JPG}
    \centering
...
Another logic controller we used is the \textit{Controllino}. Apart from digital and analog inputs and outputs, it also features relays.\todo{Why do we use it? What can it do actually?}
